...
public class BaseEntity extends BaseDataObject {
	...
	public String toString() {
		return "BaseEntity [baseEntityId=" + baseEntityId + ", identifiers=" + identifiers + ", addresses=" + addresses
		        + ", attributes=" + attributes + ", contactPoints=" + contactPoints + ", photos=" + photos + "]";
	}
