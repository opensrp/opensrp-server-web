...
public class Address {
	 ...
	 * Note that incase of multiple fields matching criteriam function would return first match. The
	...
	public int durationInMonths() {
		return startDate == null ? -1 : Months.monthsBetween(startDate, endDate == null ? DateTime.now() : endDate)
		        .getMonths();
	}
	...
	public String toString() {
		return "Address [preferred=" + preferred + ", addressType=" + addressType + ", startDate=" + startDate
		        + ", endDate=" + endDate + ", addressFields=" + addressFields + ", latitude=" + latitude + ", longitude="
		        + longitude + ", geopoint=" + geopoint + ", postalCode=" + postalCode + ", subTown=" + subTown + ", town="
		        + town + ", subDistrict=" + subDistrict + ", countyDistrict=" + countyDistrict + ", cityVillage="
		        + cityVillage + ", stateProvince=" + stateProvince + ", country=" + country + "]";
	}
