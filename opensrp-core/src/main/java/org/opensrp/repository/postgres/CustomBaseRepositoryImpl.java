...
public abstract class CustomBaseRepositoryImpl<T> {
	...
	protected static Logger logger = LoggerFactory.getLogger(CustomBaseRepositoryImpl.class.toString());
	
	protected abstract Long retrievePrimaryKey(T t, String table);
