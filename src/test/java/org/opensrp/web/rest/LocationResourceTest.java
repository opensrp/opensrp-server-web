...
public class LocationResourceTest {
	...
	public void testGetLocationByUniqueId() throws Exception {
		...
		MvcResult result = mockMvc.perform(get(BASE_URL + "/{id}", "3734").param(LocationResource.IS_JURISDICTION, "true"))
	...
	public void testGetLocationByUniqueIdShouldReturnServerError() throws Exception {
		...
		mockMvc.perform(get(BASE_URL + "/{id}", "3734").param(LocationResource.IS_JURISDICTION, "true")).andExpect(
	...
	public void testSyncLocationsByServerVersions() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		                "{\"serverVersion\":\"1542640316113\", \"is_jurisdiction\":\"true\"}".getBytes()))
		        .andExpect(status().isOk()).andReturn();
	...
	public void testGetSyncLocationsByServerVersions() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "1542640316113").param(
		                LocationResource.IS_JURISDICTION, "true")).andExpect(status().isOk()).andReturn();
		verify(locationService).findLocationsByServerVersion(1542640316113l);
		verifyNoMoreInteractions(locationService);
	...
	public void testsSyncLocationsByNames() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync")
		                    ...
		                    .content(
		                        ("{\"serverVersion\":0,\"is_jurisdiction\":\"true\", \"location_names\":[\"" + locationNames + "\"]}")
		                                .getBytes())).andExpect(status().isOk()).andReturn();
		...
		result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON)
		                    .content(
		                        ("{\"serverVersion\":\"0\",\"is_jurisdiction\":\"true\", \"location_names\":[\""
		                                + locationNames + "\"]}").getBytes())).andExpect(status().isOk()).andReturn();
		verify(locationService).findLocationsByNames(locationNames, 0l);
		verifyNoMoreInteractions(locationService);
	...
	public void testsGetSyncLocationsByNames() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "0")
	...
	public void testSyncLocationsByInvalidServerVersionsShouldReturnAllServerVersions() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		                "{\"serverVersion\": 0, \"is_jurisdiction\":\"true\"}".getBytes())).andExpect(status().isOk())
		        .andReturn();
	...
	public void testGetSyncLocationsByInvalidServerVersionsShouldReturnAllServerVersions() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "dfgdf").param(
		                LocationResource.IS_JURISDICTION, "true")).andExpect(status().isOk()).andReturn();
		verify(locationService).findLocationsByServerVersion(0l);
		verifyNoMoreInteractions(locationService);
	...
	public void testSyncLocationsShouldReturmServerError() throws Exception {
		...
		mockMvc.perform(
		    post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		        "{\"serverVersion\":\"0\", \"is_jurisdiction\": \"true\"}".getBytes())).andExpect(
		    status().isInternalServerError());
		verify(locationService).findLocationsByServerVersion(0l);
		verifyNoMoreInteractions(locationService);
	...
	public void testGetSyncLocationsShouldReturmServerError() throws Exception {
		...
		mockMvc.perform(
		    get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "0").param(LocationResource.IS_JURISDICTION, "true"))
	...
	public void testSyncStructuresByParentIdAndServerVersion() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		                "{\"serverVersion\":1542640316,\"parent_id\":[\"3734\"], \"is_jurisdiction\":\"false\"}".getBytes()))
		        .andExpect(status().isOk()).andReturn();
		...
		result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		                "{\"serverVersion\":1542640316,\"parent_id\":[\"3734,001\"], \"is_jurisdiction\":\"false\"}"
		                        .getBytes())).andExpect(status().isOk()).andReturn();
	...
	public void testGetSyncStructuresByParentIdAndServerVersion() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "1542640316").param(
		                LocationResource.PARENT_ID, "3734")).andExpect(status().isOk()).andReturn();
		verify(locationService).findStructuresByParentAndServerVersion("3734", 1542640316l);
		verifyNoMoreInteractions(locationService);
		...
		result = mockMvc
		        .perform(
		            get(BASE_URL + "/sync").param(BaseEntity.SERVER_VERSIOIN, "1542640316").param(
		                LocationResource.PARENT_ID, "3734,001")).andExpect(status().isOk()).andReturn();
		verify(locationService).findStructuresByParentAndServerVersion("3734,001", 1542640316l);
		verifyNoMoreInteractions(locationService);
	...
	public void testSyncStructuresByServerVersionsWithoutServerVersion() throws Exception {
		...
		when(locationService.findStructuresByParentAndServerVersion(null, 1542640316l)).thenThrow(
		    new IllegalArgumentException());
		MvcResult result = mockMvc
		        .perform(
		            post(BASE_URL + "/sync").contentType(MediaType.APPLICATION_JSON).content(
		                "{\"serverVersion\", \"1542640316\"}".getBytes())).andExpect(status().isBadRequest()).andReturn();
	...
	public void testCreateLocation() throws Exception {
		mockMvc.perform(post(BASE_URL).contentType(MediaType.APPLICATION_JSON).content(parentJson.getBytes())).andExpect(
		    status().isCreated());
	...
	public void testCreateLocationWithInvalidJson() throws Exception {
		mockMvc.perform(
		    post(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(parentJson.substring(4).getBytes())).andExpect(status().isBadRequest());
	...
	public void testCreateStructure() throws Exception {
		mockMvc.perform(
		    post(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "false")
		            .content(structureJson.getBytes())).andExpect(status().isCreated());
		verify(locationService).add(argumentCaptor.capture());
		verifyNoMoreInteractions(locationService);
	...
	public void testUpdateLocation() throws Exception {
		mockMvc.perform(
		    put(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(parentJson.getBytes())).andExpect(status().isCreated());
	...
	public void testUpdateLocationWithInvalidJson() throws Exception {
		mockMvc.perform(
		    put(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(parentJson.substring(6).getBytes())).andExpect(status().isBadRequest());
	...
	public void testUpdateLocationShouldReturnServerError() throws Exception {
		...
		mockMvc.perform(put(BASE_URL).contentType(MediaType.APPLICATION_JSON).content(parentJson.getBytes())).andExpect(
		    status().isInternalServerError());
		verify(locationService).update(argumentCaptor.capture());
		verifyNoMoreInteractions(locationService);
	}
	...
	public void testUpdateStructure() throws Exception {
		mockMvc.perform(
		    put(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "false")
		            .content(structureJson.getBytes())).andExpect(status().isCreated());
		verify(locationService).update(argumentCaptor.capture());
		verifyNoMoreInteractions(locationService);
		assertFalse(argumentCaptor.getValue().isJurisdiction());
	...
	public void testUpdateStructureWithInvalidJson() throws Exception {
		mockMvc.perform(
		    put(BASE_URL).contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "false")
		            .content(parentJson.substring(8).getBytes())).andExpect(status().isBadRequest());
		verify(locationService, never()).update(argumentCaptor.capture());
		verifyNoMoreInteractions(locationService);
	}
	...
	public void saveBatch() throws Exception {
		...
		mockMvc.perform(
		    post(BASE_URL + "add").contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(request.getBytes())).andExpect(status().isCreated());
	...
	public void saveBatchWithInvalidJson() throws Exception {
		mockMvc.perform(
		    post(BASE_URL + "add").contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(structureJson.getBytes())).andExpect(status().isBadRequest());
		
		ArgumentCaptor<Boolean> isParentArgumentCaptor = ArgumentCaptor.forClass(Boolean.class);
		verify(locationService, never()).saveLocations(locationsArgumentCaptor.capture(), isParentArgumentCaptor.capture());
		verifyNoMoreInteractions(locationService);
	...
	public void saveBatchShouldReturnServerError() throws Exception {
		...
		mockMvc.perform(
		    post(BASE_URL + "add").contentType(MediaType.APPLICATION_JSON).param(LocationResource.IS_JURISDICTION, "true")
		            .content(request.getBytes())).andExpect(status().isInternalServerError());
	...
	public void testGetStructuresWithinCordinatesWithoutAllParamsReturns400() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "findWithCordinates").param(LocationResource.LATITUDE, latitude + "")
	...
	public void testFindByLocationPropertiesReturnsGeometry() throws Exception {
		...
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/findByProperties").param(LocationResource.IS_JURISDICTION, "true").param(
		                LocationResource.RETURN_GEOMETRY, "true")).andExpect(status().isOk()).andReturn();
	...
	public void testFindByLocationPropertiesParamsPassedCorrectly() throws Exception {
		List<PhysicalLocation> locations = Collections.singletonList(createLocation());
		when(locationService.findLocationsByProperties(anyBoolean(), anyString(), any(Map.class))).thenReturn(locations);
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/findByProperties").param(LocationResource.IS_JURISDICTION, "true")
	...
	public void testFindByLocationPropertiesWithError() throws Exception {
		...
		MvcResult result = mockMvc.perform(get(BASE_URL + "/findByProperties")).andExpect(status().isInternalServerError())
		        .andReturn();
		verify(locationService).findStructuresByProperties(false, null, null);
	...
	public void testFindByIdWithChildren() throws Exception {
		List<PhysicalLocation> locations = Collections.singletonList(createLocation());
		when(locationService.findLocationByIdWithChildren(anyBoolean(), anyString(), anyInt())).thenReturn(locations);
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/findByIdWithChildren").param(LocationResource.JURISDICTION_ID, "j_id")
		                    .param(LocationResource.RETURN_GEOMETRY, "true")
	...
	public void testFindStructureIds() throws Exception {
		...
		MvcResult result = mockMvc.perform(get(BASE_URL + "/findStructureIds?serverVersion=0", ""))
		        .andExpect(status().isOk()).andReturn();
		...
		verifyNoMoreInteractions(locationService);
		assertEquals("{\"identifiers\":[\"structure-id-1\"],\"lastServerVersion\":12345}", result.getResponse()
		        .getContentAsString());
	...
	public void testGetAllLocations() throws Exception {
		List<PhysicalLocation> locations = Collections.singletonList(createLocation());
		when(locationService.findAllLocations(anyBoolean(), anyLong(), anyInt())).thenReturn(locations);
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/getAll").param(LocationResource.IS_JURISDICTION, "true")
		                    .param(LocationResource.RETURN_GEOMETRY, "true").param(BaseEntity.SERVER_VERSIOIN, "0"))
		        .andExpect(status().isOk()).andReturn();
		verify(locationService).findAllLocations(anyBoolean(), anyLong(), anyInt());
		assertEquals(LocationResource.gson.toJson(locations), result.getResponse().getContentAsString());
	...
	public void testGetAllStructures() throws Exception {
		List<PhysicalLocation> locations = Collections.singletonList(createStructure());
		when(locationService.findAllStructures(anyBoolean(), anyLong(), anyInt())).thenReturn(locations);
		MvcResult result = mockMvc
		        .perform(
		            get(BASE_URL + "/getAll").param(LocationResource.IS_JURISDICTION, "false")
		                    .param(LocationResource.RETURN_GEOMETRY, "true").param(BaseEntity.SERVER_VERSIOIN, "0"))
		        .andExpect(status().isOk()).andReturn();
		verify(locationService).findAllStructures(anyBoolean(), anyLong(), anyInt());
		assertEquals(LocationResource.gson.toJson(locations), result.getResponse().getContentAsString());
	...
	public void testFindLocationIds() throws Exception {
		...
		MvcResult result = mockMvc.perform(get(BASE_URL + "/findLocationIds?serverVersion=0", ""))
		        .andExpect(status().isOk()).andReturn();
		...
		verifyNoMoreInteractions(locationService);
		assertEquals("{\"identifiers\":[\"location-id-1\"],\"lastServerVersion\":12345}", result.getResponse()
		        .getContentAsString());
