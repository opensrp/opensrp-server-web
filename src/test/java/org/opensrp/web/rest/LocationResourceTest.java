...
public class LocationResourceTest {
	...
	public String searchResponseJson = "{\"type\":\"Feature\",\"id\":\"2\",\"properties\":{\"uid\":\"694e0f30-d9ac-4576-b50a-38a3ef13ebcr\",\"type\":\"Residential Structure\",\"status\":\"Pending Review\",\"parentId\":\"21\",\"name\":\"Dhaka\",\"geographicLevel\":0,\"effectiveStartDate\":\"2015-01-01T0000\",\"version\":0,\"parentName\":\"Bnagladesh\",\"tagName\":\"Division\"},\"serverVersion\":1586159649653,\"locationTags\":[{\"id\":2,\"active\":true,\"name\":\"Division\",\"description\":\"Division\"}]}";
...
//		search with more than one name
	...
	public void testGetSearchLocationsWithParams() throws Exception {
		...
		verify(locationService, never()).countSearchLocations(locationSearchBean);
		verifyNoMoreInteractions(locationService);
